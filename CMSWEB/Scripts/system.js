$(document).ready(function() {
	$.Juitter.start({
		...
		searchObject:"HotelHeritage", // Obrigatório. Você pode inserir uma palavra ou o nome do usuário. Para buscas múltiplas, separe as palavras por vírgula. Para buscar por hashtagh, utilize o %23 antes da palavra.
