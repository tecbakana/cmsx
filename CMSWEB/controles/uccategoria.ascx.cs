...
public partial class controles_produto : BaseControl
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        rptCategorias.ItemCommand += rptProdutos_ItemCommand;
    ...
    protected void CarregaMenu()
    {
        try
        {
            ...
            rptCategorias.DataSource = (Request.QueryString["areaId"] != null ? _areasrepo.ListaAreasFilha() : _areasrepo.ListaAreasPorTipo());
